# Visa/Mastercard Pairs Trading Strategy — Problem Framing Memo
**Carried forward from:** Problem Framing & Scoping (Stage 01), `homework/homework01/README.md`
...
- `docs/` — stakeholder memo and design notes
